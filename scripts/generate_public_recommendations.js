...
const KO_MODULES_VENDOR_DRIFT_COMMIT = '95f657b';  // Stand 22.09.2026 (ko-prompts.js v2.54.0, Candidate-Selection-Integrity). ACHTUNG: v2.54.1 (Fettdruck-Fix, selbes Datum) ist zum Zeitpunkt dieser Aenderung noch nicht committed — sobald das geschieht, muss dieser Wert ein weiteres Mal auf den dann neuen Commit-Hash gezogen werden.
